export function modal() {
  const project = [
    ...
    },
    {
      ...
      text: "서울시립미술관 웹사이트를 리디자인하며, 기존 디자인의 급격한 배경 색 전환과 시각 정보의 평면성을 문제로 인식했습니다. <br>사용자가 다크/라이트 모드를 직접 전환할 수 있도록 모드 전환 기능을 구현해, 갑작스러운 컬러 변화에 따른 시각적 피로를 줄였습니다. 또한 텍스트의 크기, 굵기, 색상 등을 조절해 정보의 우선순위를 시각적으로 드러내는 구조를 설계했습니다. <br>결과적으로 사용성과 가독성을 높이기 위한 시각적 구조를 설계했습니다.",
      img: [
        {
          src: "https://dain6415.github.io/my_pf/src/img/project/sema.jpg",
          alt: "서울시립미술관 사이트 목업",
        },
      ],
  ...
  function openModal(data) {
    ...
    //       ".img_box"
    //     ).innerHTML = `<img src="${data.img}" alt="${data.alt} 이미지" />`;
